...
module.exports = function (content, suffix, wpm, className) {
  ...
  return `<span class="${className}" data-totalWords="${words}" data-wordsPerMin="${wpm}">${readingTime < 1 ? '1 ' + suffix : readingTime + ' ' + suffix}</span>`
};
